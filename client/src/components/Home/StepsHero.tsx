...
const StepsHero: React.FC = () => {
  const steps = [
    {
      number: "1",
      title: "Register service endpoints",
      description: "Input your Render, Railway, Fly.io, or custom app backend URLs directly into your workspace. No code integrations or package dependency installs are needed.",
    },
    {
      number: "2",
      title: "Configure warmup schedules",
      description: "Select target ping check intervals that match your specific host's inactivity timeout thresholds to prevent backend container sleep cycles.",
    },
    {
      number: "3",
      title: "Continuous diagnostic checks",
      description: "Heimdall starts pings immediately, keeping track of latency graphs and firing off automated SMTP email alerts if a monitored instance goes offline.",
    },
  ];
