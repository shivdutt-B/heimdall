  ...
  return (
    ...
    >
          ...
          <tbody>
            {[...Array(5)].map((_, index) => (
              <tr key={index} className="border-b border-gray-800">
                ...
                <td className="p-4 align-middle">
                  <div className="w-12 h-4 bg-gray-700 rounded-[2px] animate-pulse"></div>
                </td>
                <td className="p-4 align-middle">
                  <div className="w-32 h-4 bg-gray-700 rounded-[2px] animate-pulse"></div>
                </td>
                <td className="p-4 align-middle">
                  <div className="w-36 h-4 bg-gray-700 rounded-[2px] animate-pulse"></div>
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="flex items-center justify-center px-4 py-3 border-t border-gray-800 gap-4">
        <div className="w-10 h-10 bg-gray-700 rounded-[2px] animate-pulse"></div>
        <div className="w-20 h-4 bg-gray-700 rounded-[2px] animate-pulse"></div>
        <div className="w-10 h-10 bg-gray-700 rounded-[2px] animate-pulse"></div>
      </div>
    </div>
